...
WebUI.callTestCase(findTestCase('Helper/Sidebar/Master MCU/Master'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Helper/Sidebar/Master/MasterMCU/Layanan'))
