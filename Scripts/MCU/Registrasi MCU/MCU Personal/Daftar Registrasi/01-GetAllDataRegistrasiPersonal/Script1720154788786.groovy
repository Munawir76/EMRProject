...
WebUI.click(findTestObject('Helper/Sidebar/MCU/Registrasi MCU/RegistrasiPersonal'))

WebUI.delay(1)

WebUI.click(findTestObject('Helper/Sidebar/MCU/Registrasi MCU/Registrasi Personal/Daftar Registrasi'))
